...
namespace algorithmcpp {
	...
	public:
		...
		DepthFirstDirectedPaths(const DepthFirstDirectedPaths&) = default;
		DepthFirstDirectedPaths(DepthFirstDirectedPaths &&) noexcept = default;
		DepthFirstDirectedPaths &operator=(const DepthFirstDirectedPaths &) = default;
		DepthFirstDirectedPaths &operator=(DepthFirstDirectedPaths &&) noexcept = default;
		~DepthFirstDirectedPaths() = default;

		DepthFirstDirectedPaths(const Digraph &G, size_t s) :
